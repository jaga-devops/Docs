...
```sh
kubeadm init --apiserver-advertise-address=172.31.88.163 --pod-network-cidr=192.168.0.0/16
```
##### Copy kube config
...
## Verifying the cluster IN KUBERNET MASTER AS JAGANNATH USER
##### Get Nodes status
```sh
kubectl get nodes
```
